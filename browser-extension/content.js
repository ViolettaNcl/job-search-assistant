...
function detectAts() {
  ...
  if (document.querySelector("#ashby_embed, script[src*='ashbyhq.com'][src*='embed']")) return "ashby";
  if (document.querySelector("form[action*='greenhouse.io'], [data-mapped='job-post']")) return "greenhouse";
  return "generic";
}
