...
async function fixture({letter=true,pending=false,createFails=false}={}) {
...
(async()=>{
  ...
  for(const sender of [{url:'https://evil.example/'},{url:'http://localhost:9999/'},{url:'http://localhost:8080/other'},{frameId:1}]){
